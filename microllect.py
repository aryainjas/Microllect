...
def load_settings(settings_file, default_settings):
    try:
        ...
        sg.popup_quick_message(f'exception {e}', 'Defualt setting is just good for anyone :) ', keep_on_top=True, background_color='red', text_color='white')
...
def create_main_window(settings):
    ...
    layout =  [[sg.Menu(menu_def)],
               [sg.Text('aryainjas-microllect{beta version-you can pay for higher-speed}', size=(50,1), font=('Comic sans ms', 13)), sg.Button('', key='paypal', size=(12,1), button_color=(sg.theme_background_color(), sg.theme_background_color()),
